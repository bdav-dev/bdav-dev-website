    ...
    return (
        <g>
            <defs>
                ...
                <clipPath id="squircle-clip-path-dark" clipPathUnits="userSpaceOnUse">
                    <use href="#squircle-dark"/>
                </clipPath>

                <linearGradient id="dark-background-gradient" gradientTransform="rotate(90)">
                    <stop offset="0" style={{ stopColor: '#303030' }}/>
                    <stop offset="1" style={{ stopColor: '#141414' }}/>
                </linearGradient>

                <linearGradient id="dark-highlights-gradient" gradientTransform="rotate(45 0.5 0.5)">
            ...
            <use
                href="#squircle-dark"
                style={{ fill: 'url(#dark-background-gradient)', stroke: 'none' }}
            />

            <use
                href="#squircle-dark"
                style={{ fill: 'none', stroke: 'url(#dark-highlights-gradient)', strokeWidth: 2.26772, filter: 'url(#dark-highlights-blur)' }}
                clipPath="url(#squircle-clip-path-dark)"
            />
        </g>
    );
}
