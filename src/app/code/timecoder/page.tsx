            ...
            <Article pageTitle="Timecoder">
                ...
                <Section headline="Use Timecoder">
                    <HStack className="mt-2">
                        <Tile title="Website">
                            You can use Timecoder in the web with this website: <Link href={"https://timecoder.vercel.app/"}>https://timecoder.vercel.app/</Link>
                        </Tile>
                        ...
                        <Tile title="From source code">
                            ...
                            <Enumerate
                                items={[
                                    ...
                                    "Download the source code of the project (as a .zip file or via git clone).",
                                    "Open a terminal in the project's root directory.",
                                    "Run npm install to install the project's dependencies.",
                                    "Start the developement server by entering the command npm run dev.",
                ...
                <Section headline="Features">
                    ...
                    <SubSection smallHeadline="In/Out sequences">
                        <Tile>
                            A in/out sequence consists of an in and out timecode, a difference timecode and a comment field. The in-timecode specifies the beginning of the sequence via a timecode (example: 00:01:15:14). The out-timecode specifies the end the sequence also via a timecode (example: 00:02:01:21). Timecoder automatically calculates the difference between the in and the out timecode and displays the result in the difference timecode (example: 00:00:46:07). You are able to comment the sequence, for example to state some corrections in that timeframe (example: Please add a caption here with text: "Our company is proud to announce the opening of its second factory in Berlin."). You can also delete sequences and change the arrangement by swapping them.
                        </Tile>
                    </SubSection>
                    ...
                    <SubSection smallHeadline="Share and export">
                        <Tile>
                            ...
                            <Enumerate
                                items={[
                                    "Via .csv table: The .csv table export option is perfect if you want to save your work locally or want to print it out.",
                                    "Via link: If you want to share your work with another person or want to save your work for later editing, this option is for you. The link contains a long string in which the whole state of the application is contained."
                                ]}
                            />
                        </Tile>
                    </SubSection>
