...
type A3dsImageDownloadTabeProps = {
    downloads: ImageDownload[]
}

export default function A3dsImageDownloadTabe(props: A3dsImageDownloadTabeProps) {
    const isAnyDescriptionPresent = props.downloads.find(image => image.description != undefined) != undefined;
